...
<div class="card" style="border: none; border-radius: 15px; overflow: hidden; box-shadow: 0 15px 40px rgba(0, 0, 0, 0.3); max-width: 600px;">
    <div class="card-header" style="background: #0f172a; color: #fff; padding: 20px;">
        <div class="d-flex justify-content-between align-items-center">
            <h3 style="margin: 0; font-weight: 600;">Add Grade Level</h3>
    ...
    <div class="card-body" style="padding: 30px; background: #1f2937;">
        <form action="{{ route('grade-sections.store') }}" method="POST">
            @csrf

            <div class="mb-3">
                <label class="form-label" style="font-weight: 600; color: #e5e7eb;">Grade Level</label>
                <input type="text" class="form-control" name="grade_level" value="{{ old('grade_level') }}" required style="border-radius: 10px; padding: 12px; border: 1px solid #374151; background: #111827; color: white;">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" name="section" value="{{ old('section') }}" required style="border-radius: 10px; padding: 12px; border: 1px solid #374151; background: #111827; color: white;">
